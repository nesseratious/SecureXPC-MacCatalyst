...
public extension XPCServer {
    ...
    struct MachServiceCriteria {
        ...
        ///                  requirements. Clients are also required to have
        ...
        ///                  this agent; if this agent has no team identifier an error will be thrown. Clients are also required to have
        ///                  [Hardened Runtime](https://developer.apple.com/documentation/security/hardened_runtime) enabled.
        ...
        ///                          this login item (if this login item has a team identifier) and belong to the same parent app bundle. Clients are also
        ///                          required to have [Hardened Runtime](https://developer.apple.com/documentation/security/hardened_runtime) enabled.
